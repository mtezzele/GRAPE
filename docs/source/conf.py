...
project = u'GRAPE'
copyright = u'2018-2019, GRAPE contributors'
author = u'GRAPE contributors'
...
man_pages = [
    (master_doc, 'grape', u'GRAPE Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'grape', u'GRAPE Documentation',
   author, 'grape', 'One line description of project.',
   'Miscellaneous'),
]
